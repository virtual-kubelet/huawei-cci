...
import (
	...
	"github.com/virtual-kubelet/huawei-cci/cmd/virtual-kubelet/commands/providers"
	"github.com/virtual-kubelet/huawei-cci/cmd/virtual-kubelet/commands/root"
	"github.com/virtual-kubelet/huawei-cci/cmd/virtual-kubelet/commands/version"
...
func main() {
	...
	opts.Version = strings.Join([]string{k8sVersion, "vk-huawei-cci", buildVersion}, "-")
